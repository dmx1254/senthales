    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Merci de vous être inscrit sur senthales. Pour finaliser votre inscription et accéder à votre compte, veuillez utiliser le code de vérification ci-dessous :
        </p>
