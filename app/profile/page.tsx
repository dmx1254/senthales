  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row items-start justify-center gap-8 p-4">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-6 mt-8">
        ...
        {lastOrder ? (
          <div className="flex flex-col gap-2">
            <StepperOrder status={lastOrder.paymentStatus} />
        ...
        <DialogContent className="max-w-lg p-6 rounded-xl max-h-[90vh] overflow-y-auto scrollbar-hide">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={e => setEditData(d => d && { ...d, firstname: e.target.value })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e => setEditData(d => d && { ...d, lastname: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#FFCD00]"
                  required
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={e => setEditData(d => d && { ...d, phone: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#FFCD00]"
                  required
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={e => setEditData(d => d && { ...d, address: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#FFCD00]"
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  value={editData?.city || ""}
                  onChange={e => setEditData(d => d && { ...d, city: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#FFCD00]"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={e => setEditData(d => d && { ...d, state: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#FFCD00]"
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  value={editData?.zip || ""}
                  onChange={e => setEditData(d => d && { ...d, zip: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#FFCD00]"
                />
              </div>
            </div>
            <div className="border-t pt-4 mt-2">
              <div className="font-semibold text-black/80 mb-2">Changer le mot de passe</div>
              ...
              <div className="flex items-center gap-2 mt-2">
                <input type="checkbox" id="showpass" checked={showPassword} onChange={e => setShowPassword(e.target.checked)} />
                <label htmlFor="showpass" className="text-xs text-gray-500 cursor-pointer">Afficher les mots de passe</label>
              </div>
            </div>
            ...
            <DialogFooter>
              ...
              <DialogClose asChild>
                <button type="button" className="ml-2 px-6 py-2 rounded bg-gray-200 text-gray-700 font-semibold hover:bg-gray-300 transition-colors">
                  Annuler
                </button>
              </DialogClose>
            </DialogFooter>
