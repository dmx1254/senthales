    ...
    <div className="min-h-screen bg-[#F7F7F7] flex flex-col font-montserrat">
      ...
      <div className="flex flex-col md:flex-row gap-6 px-4 md:px-8 py-6">
        ...
        <div className="mb-6 md:mb-0 md:sticky md:top-6 h-fit">
          <Sidebar category={category as string} isTitle={category as string} />
        </div>
        {/* Main content */}
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="bg-white rounded-lg p-4 flex flex-col gap-2">
            <span className="font-bold text-lg mb-2">SOUS CATÉGORIE</span>
            <ScrollArea
            ...
            >
              <div className="flex items-center justify-between gap-4 min-w-fit">
                {subcategories.slice(0, 6).map((sub, i) => (
                  <div
                    key={i}
                    className={`flex flex-col items-center w-32 sm:w-40 flex-shrink-0 px-2 sm:px-4 py-2 cursor-pointer ${
                  ...
                  >
                    <div className="w-24 h-24 sm:w-32 sm:h-28 bg-gray-100 flex items-center justify-center rounded mb-2 border">
                ...
                <div className="flex flex-col gap-2 max-h-40 overflow-y-auto pr-2">
                  {subcategories.map((cat, i) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={filters.subCategory.includes(cat.slug)}
                        onChange={(e) => {
                          if (e.target.checked) {
                            handleFilterChange({
